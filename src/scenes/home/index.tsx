...
const Home = ({ setSelectedPage }: Props) => {
  ...
  return (
    <section
      id="home"
      className="gap-16 bg-gray20 py-20 md:h-full md:pb-0"
    >
      <div className={`${flexBetween} mx-auto w-5/6`}>
        ...
        >
          ...
          <div className="z-10 mt-32 md:basis-3/5">
            ...
            >
              ...
              <p className="mt-8 font-montserrat sm:text-sm text-md">
        ...
        {isAboveMediumScreens && (
          <div className="h-[150px] w-full bg-primary100 py-10 mt-[80px]">
